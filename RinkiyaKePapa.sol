...
contract RinkiyaKePapa is Context, IERC20, Ownable {
    ...
    string private constant _name = 'RinkiyaKePapa';
    string private constant _symbol = 'RKP';
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if(sender != owner() && recipient != owner())
            require(amount <= max_tx_size, "Transfer amount exceeds Transaction amount.");
